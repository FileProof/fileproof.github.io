...
- Identity & Access Management (IAM) focus 
  ...
  - **ongoing exploration:** involved in _Convolutional Neural Network_ (CNN) new pilot study aiming to bypass vaults honeypot storing critical data in ID authentication
